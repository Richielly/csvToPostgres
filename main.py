...
class Application:
    def __init__(self, master=None):
        ...
        self.titulo = tk.Label(self.primeiroContainer,
                               text="Criar Tabelas no banco Postgre a partir de uma planilha CSV.")
        ...
        if len(OPTIONS) > 0:
            ...
            self.diretorio = tk.Label(self.quintoContainer, text='Local das planilhas esta vazio. ',
        ...
        self.diretorio = tk.Label(self.oitavoContainer, text='Local das planilhas: ' + config['default']["path"],
                                  font=self.fontePadrao)
        ...
        if self.tabela.get() == '' and self.opcoes.get() != 'Todos':
            ...
            if (self.opcoes.get() == 'Todos'):
                ...
                for tabela in arquivos_csv:
                    ...
                    mensagem = criar.criar_tabela(self.banco.get(), self.usuario.get(), self.senha.get(), tabela,
                                                  tabela.split('.')[0])
